package it.revarmygaming.commonapi.yaml;
...
public final class Configuration {
    ...
    Configuration(Map<?, ?> map, Configuration defaults, File configFile, InputStream defaultIS, boolean autosave, String version, int timeout) {
    ...
    Configuration(Map<?, ?> map, Configuration defaults) {
        this(map, defaults, null, null, false, null, 1);
    }
     ...
     * @param version This is the version of the file
     * @param timeout Timeout of checking correct version
     */
    public Configuration(File configFile, InputStream defaultIS, boolean autosave, String version, int timeout) {
        this(new LinkedHashMap<String, Object>(), null, configFile, defaultIS, autosave, version, timeout);
    }
     ...
     * @param version This is the version of the file
     */
    public Configuration(File configFile, InputStream defaultIS, boolean autosave, String version) {
        this(new LinkedHashMap<String, Object>(), null, configFile, defaultIS, autosave, version, 1);
    }
    ...
    public Configuration(File configFile, InputStream defaultIS, boolean autosave) {
        this(new LinkedHashMap<String, Object>(), null, configFile, defaultIS, autosave, null, 1);
    }
    ...
    public synchronized void load(int timeout) throws IOException, IllegalStateException {
        if (configFile == null)
        ...
        if(version != null && !getString("version").equals(version)) {
            delete();
            if(timeout != 0){
                autoload(timeout-1);
            } else {
                throw new IllegalStateException("Version is not right");
            }
        }
    }
     ...
     */
    public synchronized void autoload(int timeout) throws IOException {
